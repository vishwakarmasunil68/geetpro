package webuters.com.geet_uttarakhand20aprilpro.testing;
...
import webuters.com.geet_uttarakhand20aprilpro.activity.SavedSongsMusicPlayer;

/**
 * Created by sunil on 24-03-2018.
 */
...
public class NotificationTask extends AsyncTask<Integer, Double, Void> {
    ...
    private void setCompletedNotification() {
        ...
        Intent resultIntent = new Intent(mContext, SavedSongsMusicPlayer.class);
