 ...
 */
public class Demo_garwali_albums extends AppCompatActivity {
    ...
    static ArrayList<Catagory_calass_bean> demo_garwali_catagory_array_list = new ArrayList<Catagory_calass_bean>();
...
//        }
        ...
        btnSearchh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!boolSearch){
                    ...
                    imma.showSoftInput(etSearchh, InputMethodManager.SHOW_IMPLICIT);
                }else{
                    cat_name_txt.setVisibility(View.VISIBLE);
                    etSearchh.setVisibility(View.GONE);
                    //etSearchh.setText("");
                    boolSearch = false;
                    imma.hideSoftInputFromWindow(etSearchh.getWindowToken(), 0);
                }
    ...
    private class Catagory_datailes_Asyntask extends AsyncTask<String,String,String>{
        ...
        protected String doInBackground(String... params) {
            String CATAGORY_DETAILES = HttpULRConnect.getData("http://23.22.9.33/SongApi/singer.php?action_type=Catagorydetails&id=2");
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(Demo_garwali_albums.this);
        ...
        protected void onPostExecute(String s) {
            demo_garwali_catagory_array_list.clear();
            pDialog.dismiss();
            try {
                pDialog.dismiss();
                ...
                for (int i = 0; i < ar.length(); i++)
                {
                    ...
                    demo_garwali_catagory_array_list.add(catagory_bean);
                    Log.e("catagory array is -----+", String.valueOf(demo_garwali_catagory_array_list));
                }
            ...
            catagoryAdapter = new CatagoryAdapter(Demo_garwali_albums.this, R.layout.catagory_class_layout, demo_garwali_catagory_array_list);
            ...
            list_catagory.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                     String albumID12 = demo_garwali_catagory_array_list.get(position).getId();
                    String AlbumImage = demo_garwali_catagory_array_list.get(position).getAlbumCover();
                    String album_name= demo_garwali_catagory_array_list.get(position).getAlbumName();

                    Log.e("catagory list item clic", "item clicked");
                    Intent i = new Intent(Demo_garwali_albums.this, AlbumeSongs.class);
